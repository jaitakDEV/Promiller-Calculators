...
// // Keeps aspect ratio, fits inside a maxW x maxH box
...
// // ---- Single professional accent color (slate blue) — no black, no clashing gradients ----
// const ACCENT = [30, 64, 92] as [number, number, number]; // deep slate blue
// const ACCENT_SOFT = [230, 236, 241] as [number, number, number]; // pale tint of accent
// const TEXT_DARK = [51, 51, 51] as [number, number, number]; // soft dark gray, not pure black
// const TEXT_MUTED = [110, 110, 110] as [number, number, number];
...
//   //   // ================= HEADER (clean, white, single accent line) =================
//   //   const headerH = 80;
//   //   doc.setFillColor(...WHITE);
//   //   doc.rect(0, 0, pageW, headerH, "F");

//   //   // thin single-color top accent line
//   //   doc.setFillColor(...ACCENT);
//   //   doc.rect(0, 0, pageW, 3, "F");

//   //   const logoY = 16;
//   //   if (leftLogo) {
//   //     doc.addImage(leftLogo.url, "PNG", marginX, logoY, leftLogo.w, leftLogo.h);
//   //   }
//   //   if (rightLogo) {
//   //     doc.addImage(
//   //       rightLogo.url,
...
//   //   doc.text("Costing & Pricing Report", pageW / 2, 38, { align: "center" });

//   //   doc.setFont("helvetica", "normal");
//   //   doc.setFontSize(9);
//   //   doc.setTextColor(...TEXT_MUTED);
//   //   doc.text("Confidential — Internal Use Only", pageW / 2, 53, {
//   //     align: "center",
//   //   });
...
//   try {
//     const img = await loadImage("/logo-choyal.png");
//     const size = fitImage(img, 170, 80); // bigger box
//     leftLogo = { url: imgToDataUrl(img), ...size };
//   } catch {
//     leftLogo = null;
//   }
...
//   // ================= HEADER =================
//   const headerH = 110; // increased further to fit bigger logos
//   doc.setFillColor(...WHITE);
//   doc.rect(0, 0, pageW, headerH, "F");
...
//   doc.setFontSize(15);
//   doc.setTextColor(...ACCENT);
//   doc.text("Costing & Pricing Report", pageW / 2, headerH / 2 - 2, {
//     align: "center",
//   });
...
//   doc.setFontSize(9);
//   doc.setTextColor(...TEXT_MUTED);
//   doc.text("Confidential — Internal Use Only", pageW / 2, headerH / 2 + 14, {
//     align: "center",
//   });
...
//   doc.setDrawColor(...LINE);
//   doc.setFillColor(...WHITE);
//   doc.roundedRect(marginX, cursorY, pageW - marginX * 2, 38, 3, 3, "D");
...
//     const x = marginX + 14 + i * colW;
//     doc.setFont("helvetica", "normal");
//     doc.setFontSize(7.5);
//     doc.setTextColor(...TEXT_MUTED);
//     doc.text(label, x, cursorY + 14);
//     doc.setFont("helvetica", "bold");
//     doc.setFontSize(10.5);
//     doc.setTextColor(...TEXT_DARK);
//     doc.text(val, x, cursorY + 28);
//   });
...
//     doc.setLineWidth(1);
//     doc.line(marginX, cursorY + 4, marginX + 34, cursorY + 4);
//     cursorY += 16;
//   }

//   // ================= SECTION 1: PROCESS INPUTS =================
//   sectionTitle("1.  Wheat Process & Yield Inputs");
...
//   sectionTitle("2.  Yield Summary");

//   doc.setFillColor(...ACCENT_SOFT);
//   doc.setDrawColor(...LINE);
//   doc.roundedRect(marginX, cursorY, pageW - marginX * 2, 32, 3, 3, "FD");
//   doc.setFont("courier", "bold");
//   doc.setFontSize(10);
//   doc.setTextColor(...ACCENT);
//   doc.text(
//     `100 - ${NUM(lossSum)}%  +  ${NUM(inputs.moistureGainPct)}%  =  ${NUM(costing.yieldPct)}% Atta Yield`,
//     pageW / 2,
//     cursorY + 20,
//     { align: "center" },
//   );
...
//   if (cursorY > pageH - 220) {
//     doc.addPage();
//     cursorY = 40;
//   }

//   sectionTitle("3.  Cost Breakdown (per kg)");
...
//     [
//       { content: "MILL SALE PRICE", styles: { ...accentRow, fontSize: 10 } },
//       {
//         content: INR(costing.millSalePricePerKg),
//         styles: { ...accentRow, fontSize: 10 },
//       },
//     ],
//   ];
...
//   sectionTitle("4.  Pack-wise Final Pricing");
...
//   doc.setDrawColor(...ACCENT);
//   doc.setLineWidth(0.75);
//   doc.roundedRect(marginX, cursorY, pageW - marginX * 2, boxH, 5, 5, "FD");
...
//   doc.setFontSize(24);
//   doc.setTextColor(...ACCENT);
//   doc.text(INR(recommended?.marketPrice ?? 0), pageW / 2, cursorY + 48, {
//     align: "center",
//   });
...
//     );
//     doc.text(`Page ${i} of ${pageCount}`, pageW - marginX, footY + 14, {
//       align: "right",
//     });
